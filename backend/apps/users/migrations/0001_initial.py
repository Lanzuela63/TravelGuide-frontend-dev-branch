    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Tourist', 'Tourist'), ('Tourism Officer', 'Tourism Officer'), ('Business Owner', 'Business Owner'), ('Event Organizer', 'Event Organizer'), ('Admin', 'Admin')], default='Tourist', max_length=20)),
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=apps.users.models.user_profile_upload_path)),
