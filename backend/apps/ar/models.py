...
class ARObject(models.Model):
    scene = models.ForeignKey(ARScene, on_delete=models.CASCADE, related_name="ar_objects")
    name = models.CharField(max_length=100)
    model_url = models.URLField(max_length=200, blank=True)  # External model file URL
    rotation_deg = models.CharField(max_length=50, default="0,0,0")  # Stored as "x,y,z"
